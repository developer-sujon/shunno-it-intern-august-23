            ...
            <div className="row">
              <div className="col-lg-8 offset-lg-2 col-sm-12 col-xs-12 text-center">
                <div className="section-top-title">
                  ...
                  <p>
                    Today, computers literally run the world. Computer
                    programming languages have played an important role in
                    computer science and every major technological advancement
                    in recent years. Although there are hundreds of programming
                    languages, some have emerged as the most widely used. The
                    IT-Industry offers many exciting and successful career
                    opportunities, and computer programming has consistently
                    been a popular choice over the years. However, it demands
                    constant skill updates to adapt to evolving systems. It is
                    no secret that a career in computer programming requires
                    great skill.
                  </p>
                </div>
              </div>
