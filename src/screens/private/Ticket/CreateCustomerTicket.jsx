...
const CreateCustomerTicket = () => {
  ...
  const [ticketCreate, { data: createData, isLoading: createLoading, isSuccess: createSuccess }] = useTicketCreateMutation();
      ...
      <div className="auth-content">
        <div className="auth-wrapper">
          <div className="auth-content">
            ...
            {createSuccess && (
              <Alert style={{ background: '#21bf73', border: 0, color: '#fff' }} variant={'primary'}>
                Ticket created successfully{' '}
                <b className="">
                  <Link to={`/support-ticket/tickets/${createData?.data}?shunnoID=${shunnoID}&clientApp=${clientApp}`}>
                ...
                <div className="mt-3">
                  <Card>
                    <Card.Body className="w-100">
                      <Card.Title className="mb-3 text-center">{t('create ticket')}</Card.Title>
                      <hr />
                        ...
                        <Row className="text-start">
                          ...
                          <Col sm={6}>
                            <Form.Group className="mb-3" controlId="departmentID">
                              ...
                              />
                              {errors.departmentID && (
                                <Form.Text className="text-danger">{errors.departmentID.message}</Form.Text>
                              )}
                            </Form.Group>
                          </Col>
                        ...
                        <Row>
                          <Col sm={4}>
                            <Button size="sm" className="mt-2" type="submit">
                              {createLoading ? <Spinner size="sm" color="light" /> : t('create ticket')}
                            </Button>
                          </Col>
                        </Row>
                      </Form>
