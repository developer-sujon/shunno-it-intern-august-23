...
const CreateUpdateAgent = () => {
  ...
  const [agentCreate, { isLoading: createLoading, isSuccess: createSuccess }] =
    useAgentCreateMutation();
  const [agentUpdate, { isLoading: updateLoading, isSuccess: updateSuccess }] =
    useAgentUpdateMutation();
      ...
      yup.object({
        ...
        reference: yup
          ...
          .shape({
            name: yup
              .string()
              .required(t("reference name is required"))
              .min(3, t("name must be 3 characters long")),
            mobile: yup
              .string()
                          ...
                          render={({
                            ...
                            >
                              ...
                              {districts
                                .filter(
                                  (filterDistrict) =>
                                    filterDistrict.division_id === watchDivision
                                )
                                .map((district) => (
                                  <option
                                    value={district?.name}
                          ...
                          render={({
                            ...
                            >
                              ...
                              {upazilas
                                .filter(
                                  (filterUpazilas) =>
                                    filterUpazilas.district_id === watchDistrict
                                )
                                .map((upazila) => (
                                  <option
                                    value={upazila?.name}
                    ...
                    <Col sm={4}>
                      <Form.Group className="mb-3" controlId="reference.mobile">
                        ...
                        {errors.reference?.mobile && (
                          <Form.Text className="text-danger">
                            {errors.reference?.mobile.message}
                          </Form.Text>
                        )}
                      </Form.Group>
                    </Col>
                        ...
                        <Controller
                          ...
                          render={({
                            ...
                            <Form.Check
                              type={"checkbox"}
                              label={t(
                                `the Agent is ${!value ? "private" : "public"}`
                              )}
                              checked={value}
                              {...register("visibility")}
                            />
