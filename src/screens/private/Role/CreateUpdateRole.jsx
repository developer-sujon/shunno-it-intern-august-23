...
const CreateUpdateRole = () => {
  ...
  const [roleCreate, { isLoading: createLoading, isSuccess: createSuccess }] =
    useRoleCreateMutation();
  const [roleUpdate, { isLoading: updateLoading, isSuccess: updateSuccess }] =
    useRoleUpdateMutation();
                        ...
                        <Controller
                          ...
                          render={({
                            ...
                            <Form.Check
                              type={"checkbox"}
                              label={t(
                                `the role is ${!value ? "private" : "public"}`
                              )}
                              checked={value}
                              {...register("visibility")}
                            />
